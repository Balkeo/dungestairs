...
const TrophyButton = styled.button<any>`
  position: fixed;
  top: 12px;
  right: 104px;
  z-index: 1030;
...
const StatValue = styled.div<any>`
  font-family: Helvetica, sans-serif;
  font-size: 20px;
  font-weight: 800;
  color: ${Colors.wood};
...
const StatLabel = styled.div<any>`
  font-family: Helvetica, sans-serif;
  font-size: 10px;
...
const AchBody = styled.div<any>`
  flex: 1;
  font-family: Helvetica, sans-serif;
`

const AchName = styled.div<any>`
  font-size: 14px;
  font-weight: 700;
  color: ${({ done }) => (done ? Colors.ink : Colors.inkSoft)};
`

const AchDesc = styled.div<any>`
  font-size: 11px;
  color: ${Colors.inkSoft};
`

const AchReward = styled.div<any>`
  font-family: Helvetica, sans-serif;
  font-size: 12px;
  font-weight: 700;
...
export const Records = ({ player = ({} as any) }) => {
